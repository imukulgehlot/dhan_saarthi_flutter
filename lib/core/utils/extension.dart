...
extension TimeSpanChecker on TimeSpan {
  bool get isMax => this == TimeSpan.max;

  bool get isThreeYear => this == TimeSpan.threeYear;

  bool get isOneYear => this == TimeSpan.oneYear;

  bool get isSixMonths => this == TimeSpan.sixMonths;

  bool get isThreeMonths => this == TimeSpan.threeMonths;

  bool get isOneMonth => this == TimeSpan.oneMonth;
}
